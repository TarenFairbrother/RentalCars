    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddCors(options =>
            {
                ...
                {
                    builder.WithOrigins("https://localhost:44338", "https://localhost:5001")
                    .AllowAnyHeader()
                    .AllowAnyMethod();
                });
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, RentalCarsDbContext context)
        {
